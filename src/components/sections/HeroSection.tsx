  ...
  return (
    <section className='flex justify-between items-center mt-16 md:z-[9999]'>
      <div className='pt-32 md:pt-4'>
        <p className='text-[1.128rem] font-[700] text-primary uppercase mb-4'>Best Destinations around the world</p>
        ...
        <div className='flex gap-6 items-center '>
          ...
          <div className='flex items-center mt-6 hover:cursor-pointer'>
            <Image src='/images/play-shadow.png' alt='rounded play icon with shadow' width={100} height={100} />
