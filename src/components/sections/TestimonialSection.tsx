...
function TestimonialSection() {
  ...
  return (
    <section className='flex justify-between flex-col xl:flex-row items-center lg:-mt-[5rem] gap-16'>
      <div>
        <p className='text-lightGray text-[1.125rem] font-[600] text-left uppercase'>Testimonials</p>
        <p className='volkhov text-[3.125rem] text-title font-[700] text-left'>What People Say About Us.</p>
